...
const displayLikedPosts = () => {
    ...
    const isRemove = document.getElementById("liked").children;

  for (let item of isRemove) {
    if (item.localName == "article") {
      item.textContent = '';
    }
  }
...
const displayReportedPosts = () => {
    ...
    const isRemove = document.getElementById("reported").children;
